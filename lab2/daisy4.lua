...
t = Timer{
	Event{time = 2000, action = function(e)
		...
		-- The luminosity is increased by 4% from 2010 to 2040 every ten years
		if (e:getTime() == 2010 or e:getTime() == 2020 or e:getTime() == 2030 or e:getTime() == 2040) then
			world.luminosity = world.luminosity * world.luminosityShock
		end
